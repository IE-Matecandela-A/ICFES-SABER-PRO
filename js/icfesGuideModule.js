(function () {
  ...
  function IcfesGuideComponent() {
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "min-h-screen bg-[color:var(--color-bg)] text-[color:var(--color-text)] pb-20" }, /*#__PURE__*/

      React.createElement("header", { className: "pt-24 pb-16 px-4 text-center relative overflow-hidden" }, /*#__PURE__*/
      React.createElement("div", { className: "absolute inset-0 opacity-10", style: { backgroundImage: 'radial-gradient(circle at 2px 2px, var(--color-text-muted) 1px, transparent 0)', backgroundSize: '24px 24px' } }), /*#__PURE__*/

      React.createElement("div", { className: "relative z-10 max-w-4xl mx-auto flex flex-col items-center" }, /*#__PURE__*/
      React.createElement("div", { className: "bg-amber-500 text-indigo-900 p-4 rounded-3xl mb-6 shadow-2xl transform -rotate-3 hover:rotate-0 transition-all" }, /*#__PURE__*/
      React.createElement("span", { className: "material-icons-round", style: { fontSize: '48px' } }, "school")
      ), /*#__PURE__*/
      React.createElement("h1", { className: "text-4xl md:text-6xl font-black tracking-tight text-[color:var(--color-text)] mb-4" }, "Gu\xEDa Interactiva ", /*#__PURE__*/
      React.createElement("span", { className: "text-amber-500" }, "Saber 11\xB0")
      ), /*#__PURE__*/
      React.createElement("p", { className: "text-lg md:text-xl text-[color:var(--color-text-muted)] max-w-2xl mx-auto font-medium leading-relaxed" }, "Domina el examen de Estado con informaci\xF3n oficial, estructura clara y consejos estrat\xE9gicos."
      ...
      React.createElement("main", { className: "max-w-7xl mx-auto px-4 py-8" }, /*#__PURE__*/
      React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" },
      icfesInfo.map((item) => /*#__PURE__*/
      ...
      React.createElement("h3", { className: "text-xl font-extrabold text-[color:var(--color-text)] leading-tight" }, item.title)
      )
      ), /*#__PURE__*/
      React.createElement("div", { className: "p-6" }, /*#__PURE__*/
      React.createElement("p", { className: "text-sm opacity-60 line-clamp-2 mb-4 leading-relaxed" }, item.description), /*#__PURE__*/
      React.createElement("div", { className: "flex items-center text-amber-500 text-sm font-black uppercase tracking-wider" }, /*#__PURE__*/
      React.createElement("span", { className: "material-icons-round mr-2", style: { fontSize: '18px' } }, item.icon), /*#__PURE__*/
      React.createElement("span", null, "Explorar")
      )
      )
      )
      )
      ...
      React.createElement("button", {
        className: "absolute top-6 right-6 z-20 bg-[color:var(--color-surface-2)] border border-[color:var(--color-border)] hover:bg-[color:var(--color-primary)] p-2 rounded-full text-[color:var(--color-text)] transition-all hover:rotate-90 hover:text-white",
        onClick: () => setSelectedTopic(null) }, /*#__PURE__*/
      ...
      React.createElement("div", { className: "w-full md:w-3/5 p-8 md:p-12 overflow-y-auto" }, /*#__PURE__*/
      React.createElement("span", { className: "inline-block px-4 py-1.5 bg-[color:var(--color-primary)]/10 text-[color:var(--color-primary)] rounded-full text-xs font-black tracking-widest uppercase mb-4 border border-[color:var(--color-primary)]/20" },
      selectedTopic.category
      ), /*#__PURE__*/
      React.createElement("h2", { className: "text-3xl md:text-4xl font-black text-[color:var(--color-text)] mb-8 leading-tight" }, selectedTopic.title), /*#__PURE__*/

      React.createElement("div", { className: "bg-[color:var(--color-bg)] p-6 rounded-2xl border border-[color:var(--color-border)] mb-8" }, /*#__PURE__*/
      React.createElement("h4", { className: "text-xs font-black text-amber-500 uppercase tracking-[2px] mb-4" }, "Claves del \xC9xito"), /*#__PURE__*/
      React.createElement("ul", { className: "grid grid-cols-1 gap-3" },
      selectedTopic.highlights.map((h, i) => /*#__PURE__*/
      React.createElement("li", { key: i, className: "flex items-center text-sm font-medium text-[color:var(--color-text)]" }, /*#__PURE__*/
      React.createElement("span", { className: "material-icons-round text-amber-500 mr-3", style: { fontSize: '18px' } }, "check_circle"),
      h
      )
      )
      )
      ...
      React.createElement("h4", { className: "text-xs font-black text-amber-500 uppercase tracking-[2px] mb-4" }, "An\xE1lisis Detallado"), /*#__PURE__*/
      React.createElement("p", { className: "text-lg opacity-70 leading-relaxed font-medium" }, selectedTopic.description)
      )
      )
      )
  ...
  window.renderIcfesGuide = (containerId) => {
    ...
    if (window._reactRoots && window._reactRoots[containerId]) {
      ...
      root.render(/*#__PURE__*/React.createElement(IcfesGuideComponent, null));
    } else {
