(function() {
  ...
  const ejemplosEstrategia1 = [
    {
      ...
      calculo: (
        <ul className="text-xs space-y-2 font-mono">
          <li className="flex gap-2 items-center"><ArrowRight className="w-3 h-3 text-slate-400 shrink-0"/><span>Fórmula: c² = a² + b²</span></li>
          <li className="flex gap-2 items-center"><ArrowRight className="w-3 h-3 text-slate-400 shrink-0"/><span>Sustituir: 5² = 3² + b²</span></li>
          <li className="flex gap-2 items-center"><ArrowRight className="w-3 h-3 text-slate-400 shrink-0"/><span>Resolver: 25 = 9 + b²</span></li>
          <li className="flex gap-2 items-center"><ArrowRight className="w-3 h-3 text-fuchsia-500 shrink-0"/><span className="font-bold text-fuchsia-600">Despejar: b² = 25 - 9 = 16</span></li>
        </ul>
      ),
    ...
    },
    {
      ...
      calculo: (
        <div className="space-y-1.5 text-xs font-mono">
          ...
          <p>c² = 3600 + 6400</p>
          <p>c² = 10000</p>
          <p className="pt-2 mt-2 border-t border-slate-100 font-bold text-fuchsia-600">c = √10000</p>
        </div>
      ),
    ...
    },
    {
      ...
      calculo: (
        <ul className="text-xs space-y-1.5 font-mono">
          <li className="flex gap-2">15² = 12² + x²</li>
          <li className="flex gap-2">225 = 144 + x²</li>
          <li className="flex gap-2 text-fuchsia-600 font-bold">x² = 225 - 144 = 81</li>
          <li className="flex gap-2">x = √81</li>
        </ul>
      ),
  ...
  const ejemplosEstrategia2 = [
    {
      ...
      calculo: (
        <ul className="text-xs space-y-2 font-mono">
          <li className="flex gap-2"><span className="text-purple-600 font-bold w-16">Perímetro:</span> 10+20+10+20 = 60m. <br/>60 × $5.000 = $300k</li>
          <li className="flex gap-2 border-t border-slate-100 pt-1"><span className="text-purple-600 font-bold w-16">Área:</span> 10 × 20 = 200m². <br/>200 × $2.000 = $400k</li>
        </ul>
      ),
    ...
    },
    {
      ...
      calculo: (
        <ul className="text-xs space-y-2 font-mono">
          <li className="flex justify-between border-b border-slate-100 pb-1"><span>Área Pared (5×3):</span> <span>15 m²</span></li>
          <li className="flex justify-between border-b border-slate-100 pb-1"><span>Área Ventana (1×1):</span> <span>1 m²</span></li>
          <li className="flex justify-between text-purple-600 font-bold pt-1"><span>Resta (15 - 1):</span> <span>14 m²</span></li>
        </ul>
      ),
    ...
    },
    {
      ...
      calculo: (
        <div className="space-y-1.5 text-xs font-mono">
          <p className="text-slate-500">Radio (r) = 2m</p>
          <p>Fórmula: Área = π × 2²</p>
          <p className="font-bold text-purple-600">Área = 3.14 × 4</p>
        </div>
      ),
  ...
  const ejemplosEstrategia3 = [
    {
      ...
      calculo: (
        <ul className="text-xs space-y-2 font-mono">
          <li className="flex gap-2">Volumen = 10 × 5 × 2</li>
          <li className="flex gap-2 font-bold text-pink-600">Volumen = 100 m³</li>
          <li className="flex gap-2 border-t border-slate-100 pt-1">Costo = 100 × $1.000</li>
        </ul>
      ),
    ...
    },
    {
      ...
      calculo: (
        <ul className="text-xs space-y-2 font-mono">
          <li className="flex gap-2 text-slate-500">Base = 3 × (2²) = 3 × 4 = 12 m²</li>
          <li className="flex gap-2 text-slate-500">Vol = Área Base × Altura</li>
          <li className="flex gap-2 font-bold text-pink-600">Vol = 12 m² × 3 m</li>
        </ul>
      ),
    ...
    },
    {
      ...
      calculo: (
        <div className="space-y-1.5 text-xs font-mono">
          <p>Caja = 10 × 10 × 10 = 1000 cm³</p>
          <p>Dado = 1 × 1 × 1 = 1 cm³</p>
          <p className="pt-2 mt-2 border-t border-slate-100 font-bold text-pink-600">División: 1000 ÷ 1</p>
        </div>
      ),
  ...
  const ejemplosEstrategia4 = [
    {
      ...
      calculo: (
        <ul className="text-xs space-y-2 font-mono">
          <li className="flex gap-2">Real = 5 cm × 100.000 = 500.000 cm</li>
          <li className="flex gap-2 font-bold text-indigo-600">A km: 500.000 ÷ 100.000</li>
        </ul>
      ),
    ...
    },
    {
      ...
      calculo: (
        <ul className="text-xs space-y-2 font-mono">
          <li className="flex gap-2">Área Original: 10 × 10 = 100 m²</li>
          <li className="flex gap-2">Área Nueva: 20 × 20 = 400 m²</li>
          <li className="flex gap-2 text-indigo-600 font-bold border-t border-slate-100 pt-1">400 es CUATRO veces 100.</li>
        </ul>
      ),
    ...
    },
    {
      ...
      calculo: (
        <div className="space-y-1.5 text-xs font-mono">
          <p className="text-slate-500">Factor de escala (K) = 3</p>
          <p className="font-bold text-indigo-600">Escala Volumen = 3³ = 3×3×3 = 27</p>
          <p className="pt-1 mt-1 border-t border-slate-100">1 Litro × 27</p>
        </div>
      ),
  ...
  const questions = [
      ...
      visual: (
        <div className="w-full max-w-sm mx-auto mb-6 mt-4 flex justify-center">
           <svg className="w-40 h-32 overflow-visible" viewBox="0 0 100 80">
             <polygon points="10,70 90,70 10,10" fill="#fdf4ff" stroke="#d946ef" strokeWidth="2" />
             <polyline points="10,60 20,60 20,70" fill="none" stroke="#d946ef" strokeWidth="1" />
             <text x="50" y="85" fontSize="10" fill="#a21caf" textAnchor="middle" fontWeight="bold">8 cm</text>
             <text x="-5" y="45" fontSize="10" fill="#a21caf" textAnchor="middle" transform="rotate(-90 -5,45)" fontWeight="bold">6 cm</text>
             <text x="55" y="35" fontSize="12" fill="#c026d3" textAnchor="middle" fontWeight="bold">?</text>
           </svg>
        </div>
      ),
      ...
      visual: (
        <div className="w-full max-w-sm mx-auto mb-6 mt-4 flex justify-center">
           <svg className="w-32 h-32 overflow-visible" viewBox="0 0 100 100">
             <rect x="10" y="10" width="80" height="80" fill="#e879f9" />
             <circle cx="50" cy="50" r="40" fill="#ffffff" stroke="#c026d3" strokeWidth="2" />
             <line x1="50" y1="50" x2="90" y2="50" stroke="#c026d3" strokeWidth="2" strokeDasharray="2 2" />
             <text x="70" y="45" fontSize="8" fill="#a21caf" textAnchor="middle" fontWeight="bold">r=2m</text>
             <line x1="10" y1="95" x2="90" y2="95" stroke="#a21caf" strokeWidth="1" />
             <text x="50" y="108" fontSize="10" fill="#a21caf" textAnchor="middle" fontWeight="bold">4m</text>
           </svg>
        </div>
      ),
      ...
      visual: (
        <div className="w-full max-w-sm mx-auto mb-6 mt-4 flex justify-center">
           <svg className="w-40 h-40 overflow-visible" viewBox="0 0 100 100">
             <path d="M 20 80 L 80 80 L 80 40 L 50 40 L 50 20 L 20 20 Z" fill="#f3e8ff" stroke="#a855f7" strokeWidth="3" />
             <text x="50" y="95" fontSize="10" fill="#7e22ce" textAnchor="middle" fontWeight="bold">6m</text>
             <text x="5" y="50" fontSize="10" fill="#7e22ce" textAnchor="middle" transform="rotate(-90 5,50)" fontWeight="bold">6m</text>
             <text x="65" y="32" fontSize="14" fill="#d946ef" textAnchor="middle" fontWeight="bold">?</text>
           </svg>
        </div>
      ),
      options: [
    ...
    },
    {
      ...
      visual: (
        <div className="w-full max-w-sm mx-auto mb-6 mt-4 flex items-center justify-center p-4 bg-purple-50 rounded-xl border border-purple-100">
           <div className="flex flex-col items-center">
              <Layers className="w-12 h-12 text-purple-400 mb-2" />
              <div className="flex gap-4 font-mono font-bold text-purple-800">
                <span>L: 10m</span> <span>A: 4m</span> <span>P: 2m</span>
              </div>
           </div>
        </div>
      ),
        ...
        <div className="w-full max-w-sm mx-auto mb-6 mt-4 p-5 bg-white rounded-xl shadow-sm border border-slate-200">
           <div className="flex justify-between items-center">
             <div className="text-center">
               <Square className="w-8 h-8 text-slate-400 mx-auto mb-1" />
               <span className="text-[10px] font-bold text-slate-500 uppercase">Original (K=1)</span>
             </div>
             <ArrowRight className="w-6 h-6 text-fuchsia-500" />
             <div className="text-center">
               <Square className="w-16 h-16 text-fuchsia-500 mx-auto mb-1" />
               <span className="text-[10px] font-bold text-fuchsia-600 uppercase">Agrandado (K=3)</span>
             </div>
           </div>
        </div>
      ),
    ...
    },
    {
      ...
      visual: (
        <div className="w-full max-w-sm mx-auto mb-6 mt-4 p-4 bg-slate-50 rounded-xl shadow-sm border border-slate-200 flex justify-center items-center gap-6">
          <div className="text-center">
            <Box className="w-10 h-10 text-fuchsia-500 mx-auto mb-2" />
            <span className="text-xs font-bold text-slate-600 block">Jarra: 10x10x20 cm</span>
          </div>
        </div>
      ),
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-slate-50 via-fuchsia-50/30 to-slate-200 font-sans text-slate-800 p-4 md:p-8 flex items-center justify-center">
      <div className="max-w-6xl w-full mx-auto bg-white/80 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(217,70,239,0.1)] overflow-hidden border border-white">
        
        {/* Header - Tema Fucsia/Púrpura Premium */}
        <header className="relative bg-[#150A15] p-8 md:p-14 overflow-hidden">
          <div className="absolute -top-32 -right-32 w-[35rem] h-[35rem] bg-fuchsia-500/20 blur-[120px] rounded-full pointer-events-none"></div>
          <div className="absolute -bottom-32 -left-32 w-[35rem] h-[35rem] bg-purple-600/20 blur-[120px] rounded-full pointer-events-none"></div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-3 mb-6 px-5 py-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-full shadow-lg">
                ...
                <span className="text-fuchsia-300 font-bold tracking-widest text-xs uppercase">Módulo de Competencia 5</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-black mb-5 text-white tracking-tight leading-tight">
                Pensamiento <br className="hidden md:block"/><span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-purple-400">Geométrico</span>
              </h1>
              <p className="text-slate-300 text-lg leading-relaxed font-light max-w-xl">
                Evalúa tu capacidad espacial y métrica: domina áreas, volúmenes, el Teorema de Pitágoras y las leyes matemáticas de escalabilidad visual.
              </p>
            </div>
            <div className="hidden md:flex items-center justify-center w-24 h-24 bg-gradient-to-br from-fuchsia-500 to-purple-600 rounded-[2rem] shadow-[0_0_40px_rgba(217,70,239,0.3)] transform rotate-6 border border-white/10">
        ...
        <nav className="px-6 md:px-12 pt-8 pb-4">
          <div className="flex bg-slate-100/60 backdrop-blur-md p-1.5 rounded-2xl border border-slate-200/60 overflow-x-auto hide-scrollbar">
            {[
              ...
              >
                <tab.icon className={`w-4 h-4 ${activeTab === tab.id ? 'text-fuchsia-500' : ''}`} />
                {tab.label}
              </button>
            ))}
          </div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div className="space-y-6">
                  <h2 className="text-3xl font-extrabold text-slate-800 tracking-tight">Geometría para la prueba</h2>
                  <p className="text-slate-600 leading-relaxed text-lg font-light">
                    Esta sección busca evaluar si puedes <strong className="font-semibold text-fuchsia-700">imaginar formas en tu cabeza</strong> y convertirlas en medidas reales. No es solo aplicar fórmulas, es "ver" la solución en un plano.
                  </p>
                  
                  <div className="bg-gradient-to-br from-white to-fuchsia-50/30 backdrop-blur-xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] rounded-3xl p-8 relative overflow-hidden group">
                    <div className="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-fuchsia-400 to-purple-500 rounded-l-3xl"></div>
                    <h3 className="font-bold text-slate-800 mb-6 text-lg">Los 4 pilares de la Geometría:</h3>
                    <ul className="space-y-5">
                      {[
                        ...
                        <li key={i} className="flex items-start gap-4 text-slate-600">
                          <div className="mt-0.5 bg-fuchsia-100 p-1.5 rounded-lg shrink-0 group-hover:bg-fuchsia-500 group-hover:text-white transition-colors duration-300">
                            <CheckCircle className="w-3.5 h-3.5 text-fuchsia-600 group-hover:text-white" />
                          </div>
                ...
                <div className="bg-gradient-to-b from-slate-50 to-fuchsia-50/50 rounded-[2.5rem] p-10 border border-white flex flex-col items-center justify-center relative shadow-inner overflow-hidden">
                  <div className="relative w-full h-80 flex items-center justify-center" style={{ perspective: '1200px' }}>
                    ...
                    <div 
                      ...
                      style={{ transform: 'rotateX(60deg) rotateZ(-20deg)', transformStyle: 'preserve-3d' }}
                    >
                      <div className="absolute inset-0 bg-white/80 backdrop-blur-md border border-fuchsia-200 rounded-[2rem] shadow-[0_30px_50px_rgba(217,70,239,0.15)]" style={{ transform: 'translateZ(-1px)' }}></div>
                      <div className="absolute bottom-8 left-8 w-20 h-20 bg-gradient-to-tr from-fuchsia-600 to-pink-400 rounded-xl shadow-xl flex items-center justify-center" style={{ transform: 'translateZ(1px)' }}><Box className="w-10 h-10 text-white/90" /></div>
                      <div className="absolute top-8 right-10 w-20 h-20 bg-gradient-to-tr from-purple-600 to-indigo-400 rounded-full shadow-xl flex items-center justify-center" style={{ transform: 'translateZ(1px)' }}><Triangle className="w-10 h-10 text-white/90" /></div>
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center shadow-[0_20px_40px_rgba(0,0,0,0.1)] border-2 border-fuchsia-300" style={{ transform: 'translateZ(80px)' }}>
                        <Ruler className="w-10 h-10 text-fuchsia-600" />
                      </div>
                    </div>
                  </div>
                  <p className="text-[15px] text-slate-500 font-medium italic mt-6 text-center max-w-sm">
                    "La geometría es el arte de pensar bien, dibujando mal."
                  </p>
                  <button 
                  ...
                  >
                    Ver Teoría y Ejemplos <ArrowRight className="w-5 h-5" />
                  </button>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'teoria' && (
            <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 space-y-12">
              <div className="text-center max-w-3xl mx-auto mb-12">
                <h2 className="text-3xl md:text-4xl font-extrabold text-slate-800 tracking-tight mb-4">Leyes y Fórmulas Geométricas</h2>
                <div className="w-24 h-1.5 bg-gradient-to-r from-fuchsia-400 to-purple-500 mx-auto rounded-full mb-6"></div>
              </div>

              {/* Fragmentos de teoría portados */}
              <div className="space-y-6">
                <div className="flex items-center gap-4 border-b-2 border-slate-100 pb-4">
                  <div className="p-3 bg-fuchsia-100 rounded-xl shadow-sm border border-fuchsia-200">
                    <Triangle className="w-6 h-6 text-fuchsia-600" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-800">1. Teorema de Pitágoras</h3>
                </div>
              ...
              <div className="space-y-6 pt-10">
                <div className="flex items-center gap-4 border-b-2 border-slate-100 pb-4">
                  <div className="p-3 bg-purple-100 rounded-xl shadow-sm border border-purple-200">
                    <Square className="w-6 h-6 text-purple-600" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-800">2. Áreas y Perímetros (2D)</h3>
                </div>
              ...
              <div className="space-y-6 pt-10">
                <div className="flex items-center gap-4 border-b-2 border-slate-100 pb-4">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800">3. Volúmenes y Capacidad (3D)</h3>
                </div>
              ...
              <div className="space-y-6 pt-10">
                <div className="flex items-center gap-4 border-b-2 border-slate-100 pb-4">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800">4. Escalas y Transformaciones</h3>
                </div>
            ...
            <div className="animate-in fade-in zoom-in-95 duration-500 max-w-3xl mx-auto">
              {!showResults ? (
                <div className="bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-100 p-8 md:p-12 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-fuchsia-50 rounded-full blur-3xl -z-10 transform translate-x-1/2 -translate-y-1/2"></div>
                  <div className="mb-8 flex justify-between items-end">
                    <div>
                      <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-2">Desafío Geométrico: <span className="text-fuchsia-500">{questions[currentQuestion].type}</span></p>
                  ...
                  <div className="w-full bg-slate-100 h-2.5 rounded-full mb-10 overflow-hidden shadow-inner">
                    <div className="bg-gradient-to-r from-fuchsia-400 to-purple-500 h-full transition-all duration-500 ease-out" style={{ width: `${((currentQuestion + 1) / questions.length) * 100}%` }}></div>
                  </div>
                  <h3 className="text-xl font-medium text-slate-700 mb-6 leading-relaxed">{questions[currentQuestion].question}</h3>
                  {questions[currentQuestion].visual && (
                    <div className="w-full bg-slate-50/70 rounded-2xl border border-slate-200/60 p-2 md:p-6 mb-8 shadow-inner">{questions[currentQuestion].visual}</div>
                  )}
                    ...
                    {questions[currentQuestion].options.map((option, index) => (
                      <button key={index} onClick={() => handleAnswer(index)} disabled={hasAnswered} className={`w-full text-left p-5 rounded-2xl border-2 transition-all duration-300 ${hasAnswered ? index === questions[currentQuestion].correct ? 'bg-emerald-50/50 border-emerald-400 text-emerald-900 shadow-[0_8px_20px_rgba(52,211,153,0.15)] scale-[1.02]' : index === selectedAnswer ? 'bg-rose-50/50 border-rose-300 text-rose-900 scale-[0.98] opacity-80' : 'bg-white border-slate-100 text-slate-400 opacity-50' : 'bg-white border-slate-100 hover:border-fuchsia-300 hover:shadow-[0_8px_30px_rgba(217,70,239,0.05)] text-slate-600 hover:-translate-y-1'}`}>
                        <div className="flex items-center gap-4">
                          <div className={`w-7 h-7 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${hasAnswered ? index === questions[currentQuestion].correct ? 'border-emerald-500 bg-emerald-500 text-white' : index === selectedAnswer ? 'border-rose-400 bg-rose-400 text-white' : 'border-slate-200' : 'border-slate-200'}`}>
                  ...
                  {hasAnswered && (
                    <div className={`p-6 rounded-2xl mb-8 animate-in slide-in-from-top-4 ${selectedAnswer === questions[currentQuestion].correct ? 'bg-emerald-50 border border-emerald-100 text-emerald-800' : 'bg-rose-50 border border-rose-100 text-rose-800'}`}>
                      <p className="font-semibold text-sm md:text-base">{questions[currentQuestion].feedback}</p>
                    </div>
                  )}
                  <div className="flex justify-end">
                    <button onClick={nextQuestion} disabled={!hasAnswered} className={`px-8 py-4 rounded-xl font-bold flex items-center gap-3 transition-all duration-300 ${hasAnswered ? 'bg-slate-900 hover:bg-slate-800 text-white shadow-[0_10px_20px_rgba(0,0,0,0.1)] hover:-translate-y-1' : 'bg-slate-100 text-slate-400 cursor-not-allowed'}`}>
                      {currentQuestion === questions.length - 1 ? 'Ver Resultado Final' : 'Siguiente Simulación'} <ArrowRight className="w-5 h-5" />
                    </button>
                  </div>
                </div>
              ) : (
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-[0_20px_60px_-15px_rgba(217,70,239,0.15)] border border-white p-10 md:p-16 text-center animate-in zoom-in-95 duration-500 relative overflow-hidden">
                  <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-fuchsia-400 via-purple-500 to-indigo-500"></div>
                  <div className="w-28 h-28 mx-auto bg-gradient-to-br from-fuchsia-100 to-purple-50 rounded-full flex items-center justify-center mb-8 shadow-inner border border-white">
                    <Award className="w-14 h-14 text-fuchsia-600" />
                  </div>
                  ...
                  <div className="bg-gradient-to-b from-slate-50 to-white rounded-3xl p-8 mb-10 max-w-sm mx-auto border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                    <div className="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-purple-600 mb-2">{score} <span className="text-3xl text-slate-300 font-bold">/ {questions.length}</span></div>
                    <p className="text-slate-400 font-bold uppercase tracking-widest text-xs mt-4">Puntaje Geométrico</p>
                  </div>
                  <button onClick={resetQuiz} className="bg-slate-900 hover:bg-slate-800 text-white px-10 py-4 rounded-xl font-bold transition-all flex items-center gap-3 mx-auto">
