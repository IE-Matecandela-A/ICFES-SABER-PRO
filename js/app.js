        ...
        try {
            ...
            this.allStudents = Object.entries(usersData)
                ...
                .map(([firebaseKey, userObj]) => {
                    ...
                    const history = allResults.filter(r => (r.studentName || '').trim().toLowerCase() === safeProfileName);
            ...
            .then(profile => {
                ...
                return fetch('https://plataforma-icfes-13421-default-rtdb.firebaseio.com/results.json?t=' + Date.now())
                    ...
                    .then(resultsData => {
                        ...
                        const historyArr = allResults.filter(r => (r.studentName || '').trim().toLowerCase() === safeProfileName);
