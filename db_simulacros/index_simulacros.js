...
const NATIVE_EXAMS_DB = {
    ...
    examenes: [
        ...
        {
            id: "mat_sim_05",
            titulo: "Simulacro Matemáticas 05 (JSON)",
            descripcion: "Quinto examen interactivo enfocado en resolución de problemas matemáticos.",
            area: "matematicas",
            preguntas_count: 20,
            tiempo_minutos: 40,
            dificultad: "Media-Alta",
            archivo_js: "db_simulacros/matematicas/mat_simulacro_05.js"
        },
        {
            id: "nat_sim_01",
        ...
        {
            id: 'mat_sim_06',
            titulo: 'Simulacro Matemáticas 06 (PDF)',
            descripcion: 'Sexto simulacro de matemáticas con preguntas de análisis de gráficas, geometría y probabilidad.',
            area: 'matematicas',
            preguntas_count: 26,
            tiempo_minutos: 15,
            dificultad: 'Media-Alta',
