...
window.NATIVE_EXAM_DATA.push(...[
    ...
    },
    {
        ...
        "grafica": {
            "tipo": "geometry",
            "titulo": "Vistas de un sólido (Superior, Frontal, Lateral)",
            "datos": {
                "labels": [
                    "Altura Frontal",
                    "Altura Media",
    ...
    },
    {
        ...
        "grafica": {
            "tipo": "geometry",
            "titulo": "Simetría Axial (Reflexión)",
            "datos": {
                "labels": [
                    "Cuadrante II (Polígono 1)",
                    "Cuadrante I (Polígono 2)"
                ],
                "datasets": [
                    {
                        "label": "Coordenadas X",
